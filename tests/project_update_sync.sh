...
sed \
  -e 's#moribit/Akamata/archive/refs/tags/v0.1.3#appleuser634/Akamata/archive/refs/tags/v0.1.0#' \
  -e 's#akamata-0.1.3-uJIoIxf5LAFuRQ45_Lm7Axug4u7ZZApnO5XwzFmiVyQ8#akamata-0.1.0-uJIoI4fvKwH--xMKwulRpDc6xEEUfaP0oilU6-dfUqbw#' \
...
dry_output=$("$cli" update --to=v0.1.3 --sync --dry-run 2>&1)
...
"$cli" update --to=v0.1.3 --sync
grep -F 'refs/tags/v0.1.3.tar.gz' build.zig.zon >/dev/null
