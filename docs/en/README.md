...
This is the documentation home for Akamata v0.1.0 and Zig 0.16.x. Start with the Quick Start if you are evaluating the framework, then use the Handbook or Tutorial for a deeper walkthrough.

**Release status:** v0.1.0 is the current public 0.x release. The `main` branch
