-- Schema for mobus port. Originally from mobus_server_zig/migrations consolidated.
...
CREATE INDEX IF NOT EXISTS idx_calls_receiver ON call_logs(receiver_id);
CREATE INDEX IF NOT EXISTS idx_envelopes_receiver ON envelopes(receiver_id, created_at);
CREATE INDEX IF NOT EXISTS idx_prekeys_device ON device_one_time_prekeys(device_id);
